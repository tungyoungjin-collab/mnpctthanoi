...
// ========================================
// TẠO CÁC DATASET CHO CÁC NGƯỠNG CẢNH BÁO
// ========================================
...
function createThresholdDatasets(numLabels, stationId) {
    ...
    // Dataset cho Level 1 (Vàng) - Cảnh báo 1
    datasets.push({
...
function buildChartConfig(chartData, stationName, stationId) {
    ...
    // Thêm các đường ngưỡng cảnh báo
    ...
    return {
        ...
        data: {
            ...
            datasets: [waterLevelDataset, ...thresholdDatasets]
        },
        options: {
            responsive: true,
            plugins: {
...
function applyChartData(chartData, stationName, stationId) {
    ...
    waterChart.data.datasets = [waterLevelDataset, ...thresholdDatasets];
